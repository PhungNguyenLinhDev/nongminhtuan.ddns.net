...
// ABOUT ME
document.getElementById("ThanhDieuAbout_1").innerHTML = 'ThanhDieu.Com is a free source code sharing blog with quality and diverse content, we want to become a trusted destination for the programming community.';
// FOOTER
...
aElement.href = "//facebook.com/100035052735014";
...
const ThanhDieu_List = [
  "//files.catbox.moe/zurq9k.mp3", // Mây Đêm Chờ Mấy Đêm
...
function Youtube() {
  setTimeout(function() {
    window.open('https://www.youtube.com/channel/UCiSP9FWliPIwG-w59dJdilQ', '_blank')},
  100);
}
function Facebook() {
  setTimeout(function() {
...
function Discord() {
  setTimeout(function() {
    window.open('https://discord.gg/HCZyytQ3Sp', '_blank')},
  100);
}
function Instagram() {
  setTimeout(function() {
    window.open('https://instagram.com/vuongsondieu2k2/', '_blank')},
  100);
}
...
toastDiv.id = 'Toast';
toastDiv.textContent = '𝘿𝙚𝙨𝙞𝙜𝙣𝙚𝙧 𝙗𝙮 𝙏𝙝𝙖𝙣𝙝𝘿𝙞𝙚𝙪 =))';
